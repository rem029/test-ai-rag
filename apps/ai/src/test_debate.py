...
async def debate(
    topic="Aliens", rounds=10, a1_title="Alien Believer", a2_title="Non Alien Believer"
):
    """
        ...
        async with httpx.AsyncClient(timeout=httpx.Timeout(300.0)) as client:
            ...
            for round_num in range(1, rounds + 1):
                ...
                async with client.stream(
                    ...
                    json={
                        "text": f"AI 2: {ai1_response}",
                        "context": context,
                        "playAudio": False,
                        "session_id": ai2_session_id,
                        "stream": True,
                    },
                    headers={"Content-Type": "application/json"},
                ) as response_ai2:
            ...
            async with client.stream(
                ...
                json={
                    ...
                    "context": (
                        f"Topic is discussed is about {topic}"
